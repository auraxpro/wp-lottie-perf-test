<?php
/**
 * Template Name: Deferred Local Performance Test
 * 
 * This template displays the Tipalti Finance AI replica with Deferred Local Lottie integration
 */
    ...
    <section id="test-info" style="padding: 2rem 0; background: var(--secondary-color);">
        <div class="container">
            <div style="text-align: center; padding: 1rem; background: white; border-radius: 8px; box-shadow: var(--shadow);">
                <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">⏳ Deferred Local Performance Test</h3>
                <p style="color: var(--text-secondary); margin-bottom: 1rem;">This page uses Deferred Local loading strategy - Lottie player loaded with requestIdleCallback</p>
                <div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap;">
                    <span><strong>Expected Score:</strong> ~90</span>
                    <span><strong>Strategy:</strong> Local with defer</span>
                    <span><strong>Load Time:</strong> When browser idle</span>
                </div>
            </div>
        </div>
    </section>
